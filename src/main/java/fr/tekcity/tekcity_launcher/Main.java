...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // On ajoute un gestionnaire d'événements lorsque l'utilisateur souhaite se connecter
        LoginController tryToLogin = new LoginController();
        ...
        // On instancie l'évenement du bouton
        loginButton.setOnAction(tryToLogin);
        ...
        // On créer une scène pour le formulaire de connexion
        Scene loginScene = new Scene(root, 1000, 568);

        // Défini la scène pour la fenêtre
        primaryStage.setScene(loginScene);
        primaryStage.setMinWidth(1000);
        primaryStage.setMinHeight(568);

        // Défini le titre de la fenêtre d'application
        primaryStage.setTitle("Launcher de TekCity");

        // Affiche la fenêtre d'application
        primaryStage.show();
    }
